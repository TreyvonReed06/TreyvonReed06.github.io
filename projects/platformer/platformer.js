$(function () {
  ...
  function setup() {
    ...
    createPlatform(900,450,100,25);
    createPlatform(700,350,100,25);
    ...
    createCollectable("diamond",700,300,20,0.5);
    createCollectable("grace",900,500,20,0.5);
    createCollectable("max",400,200,20,0.5)
